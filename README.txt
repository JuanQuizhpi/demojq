...
a persistence unit "demojqPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demojq/pom.xml":
...
artifact ("demojq.war") is already built. You can build
